    ...
    switch (clickedButtonValue) {
      ...
      case 'INICIAR CHAMADA':
        window.setTimeout(() => {
          ...
          $.ajax({
            url:
              'https://hubapi.falemaisvoip.com.br:8443/fale-mais/v1/calls/?hubId=' +
              hubId +
              '&email=' +
              emailUser,
            type: 'post',
            ...
            success: function (data) {
              ...
              function validacaoChamada(callId) {
                $.ajax({
                  url:
                    'https://hubapi.falemaisvoip.com.br:8443/fale-mais/v1/calls?callId=' +
                    callId +
                    '&hubId=' +
                    hubId +
                    '&email=' +
                  ...
                  success: function (dataStatus) {
                    ...
                    if (
                      dataStatus.state === 'finished' ||
                      dataStatus.state === 'failed' ||
                      dataStatus.state === 'string' ||
                      dataStatus === '' ||
                      dataStatus == null ||
                      ...
                      $.ajax({
                        url:
                          'https://hubapi.falemaisvoip.com.br:8443/hubspot/v1/api/contact/engagement?callId=' +
                          callId +
                          '&called=' +
                          state.phoneNumber +
                          '&engagementId=' +
